...
class HabitTestCase(APITestCase):
    ...
    def test_habit_list_public(self):
        ...
        url = reverse('habit:habits_public_list')
    ...
    def test_habit_update(self):
        ...
        url = reverse('habit:habits_update', args=(self.habit.pk,))
    ...
    def test_habit_delete(self):
        ...
        url = reverse('habit:habits_delete', args=(self.habit.pk,))
